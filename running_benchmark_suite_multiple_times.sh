...
export NIGHTHAWK_CONNECTIONS=50 # http1
export NIGHTHAWK_MAX_REQUEST_PER_CONNECTION=10 # http2
export NIGHTHAWK_DURATION=30
...
###
export NIGHTHAWK_MAX_REQUEST_PER_CONNECTION=250
export NIGHTHAWK_CONNECTIONS=5
...
##
# Test by RPS, with body size 512kb
##
export TOP_DIR=/home/hejiexu/cpu-affinity-benchmark/auto_reservation_size_test_tls_with_single_reservation_by_rps2
mkdir -p $TOP_DIR
export NIGHTHAWK_REQUEST_BODY_SIZE=524288
IFS=";"
for i in `echo "50;100;150;200;250"`; do
    export SUITE_DIR=${TOP_DIR}/$i
    export NIGHTHAWK_RPS=$i
    echo "Test RPS ${NIGHTHAWK_RPS}" 
    export NIGHTHAWK_REQUEST_METHOD=POST
    bash ./running_benchmark_suite_all_bins.sh
done
...
export TOP_DIR=/home/hejiexu/cpu-affinity-benchmark/auto_reservation_size_test_tls_with_single_reservation_h2_by_rps2
mkdir -p $TOP_DIR
export NIGHTHAWK_OTHER_OPT=--h2
export NIGHTHAWK_REQUEST_BODY_SIZE=524288
IFS=";"
